    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media ();  ?>images/usuario.png" alt="User Image" >
        <div>
          <p class="app-sidebar__user-name">Mani</p>
      ...
      <ul class="app-menu">
        ...
        <li>
          <a class="app-menu__item" href="<?= base_url ();  ?>clientes/"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Clientes</span></a></li>
        ...
        <li><a class="app-menu__item" href="<?= base_url ();  ?>logout/"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Salir</span></a></li>
